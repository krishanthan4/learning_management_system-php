...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 " id="signInDiv">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    <img class="mx-auto h-10 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=purple&shade=600"
      alt="Your Company">
    <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Academic Officer Sign In</h2>
  </div>
  <?php
$email = "";
$password = "";
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm space-y-6">
    ...
    <div>
      <div class="flex items-center justify-between">
        ...
        <div class="text-sm">
          <div onclick="forgotPassword();" class="font-semibold cursor-pointer text-purple-600 hover:text-purple-500">
            Forgot password?</div>
        </div>
      </div>
      <div class="mt-2">
