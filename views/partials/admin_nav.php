  ...
  <div class="fixed inset-0 flex z-40 lg:hidden" role="dialog" aria-modal="true">
    ...
    <div class="relative max-w-xs w-full bg-white shadow-xl pb-12 flex flex-col overflow-y-auto" id="MobileMenu">
      ...
      <div class="border-t border-gray-200 py-6 text-center space-y-6">
        ...
        <div class="flow-root">
          <a href="/manage-admins" class="-m-2 p-2 block font-medium text-gray-900">Manage Admins</a>
        </div>
        <div class="flow-root">
            ...
            <div class="hidden lg:flex-1 lg:block lg:self-stretch">
              <div class="h-full flex space-x-8">
                ...
                <a href="/admin/manage-academic-officers"
                  class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">Manage Academic Officers</a>
                <a href="/admin"
                  class="flex items-center text-sm font-medium text-gray-700 hover:text-gray-800">  History</a>
              </div>
            </div>
          </div>
        </div>
