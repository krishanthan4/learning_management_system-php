...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 " id="signInDiv">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    <h2 class="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">Student Sign Up</h2>
  </div>
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm space-y-6">
    ...
    <div>
      <button onclick="student_signup();"
        class="flex w-full justify-center rounded-md bg-orange-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-orange-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange-600">Register Now</button>
        <p class="text-center text-orange-400 text-sm mt-5"><a href="/student/signin">Sign In</a></p>
    </div>
...
<script src="/public/js/student/studentSignin.js"></script>
